...
const Like = (props) => {
  ...
  const iconNotLikedSVG =
    <svg role="likeIcon" className="w-5 h-5 text-blue-700"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22">
  ...
  const iconLikedSVG =
    <svg role="likeIcon" className="w-5 h-5 text-blue-700"  xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 22">
  ...
  return (
    <div role="likeDiv" className="flex justify-start items-center align-middle">
      <button role="likeButton" type="button" onClick={handlePostLike} className="">
        {iconSVG}
      </button>
      <span role="likeNumber" className="ms-2">{likes}</span>
    </div>
  );
}
