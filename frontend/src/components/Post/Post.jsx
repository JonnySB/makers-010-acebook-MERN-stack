...
const Post = (props) => {
  ...
  return (
    ...
    >
      <div
        className={
          "border border-white " + (props.commentModal ? "w-full" : "w-1/2")
        }
      >
        <div className="pt-2 p-4 bg-white">
        ...
        <div className="grid grid-cols-2 grid-rows-1 border-t px-4 py-2 text-xs text-neutral-500 bg-white">
          <Like
