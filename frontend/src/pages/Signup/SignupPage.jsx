        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                ...
                />
                  {/* {isValid ? (
                    <p data-testid="valid-password" className="font-medium text-green-600 dark:text-green-500">
                      Password is valid!
                    </p>
                  ) : (
                    <p data-testid="invalid-password" className="font-medium text-red-600 dark:text-red-500">
                      Password is invalid!
                    </p>
                  )} */}
                {isValid 
                ...
                : <p className="font-medium text-red-600 dark:text-green-500">
